...
router.get('/products', sessionMiddleware.couldBeAuthenticated,cartMiddleware.itemsInCart, productController.renderAll)
router.get('/products/:id', sessionMiddleware.couldBeAuthenticated, cartMiddleware.itemsInCart,productController.renderProduct)
